...
Bestaande Switch entities uit oudere versies die met een raw holding register zijn opgeslagen blijven werken voor backward compatibility. Nieuwe Switches vragen geen raw Modbus-register of 0–255-waarden meer.
